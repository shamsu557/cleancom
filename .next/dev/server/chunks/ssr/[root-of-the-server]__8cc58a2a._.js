...
;
const metadata = {
    title: "Cleancom - Professional Cleaning Services",
    description: "Connect with verified cleaning service providers for home, office, and specialized cleaning needs. Book, track, and pay - all in one place.",
    generator: "v0.app",
    icons: {
        icon: [
            {
